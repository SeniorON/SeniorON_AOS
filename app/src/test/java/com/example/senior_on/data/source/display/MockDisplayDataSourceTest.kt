...
class MockDisplayDataSourceTest {
    @Test
    ...
    fun notConnectedScenarioProvidesNoDevice() {
        val repository = MockDisplayDataSource(MockDisplayScenario.NotConnected)
    ...
    fun screenConfigurationUpdatesWithoutBackend() {
        val repository = MockDisplayDataSource()
    ...
    fun savedParentInfoIsSharedWithObservers() {
        val repository = MockParentInfoDataSource(MockSeniorFixtures.mother)
